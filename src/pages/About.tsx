          ...
          <div className="flex-1">
            ...
            >
              ...
              <div className={`space-y-4 text-sm leading-relaxed ${isDark ? "text-white/45" : "text-gray-600"}`}>
                <p>
                  Backend Engineer with 1.5+ years owning Python/FastAPI microservices in production. CS graduate with an AI major from Bennett University, targeting Backend, Data Engineering, and Applied AI roles.
                </p>
                <p>
